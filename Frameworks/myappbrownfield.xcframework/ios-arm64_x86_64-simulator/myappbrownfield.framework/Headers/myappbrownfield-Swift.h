...
#ifndef MYAPPBROWNFIELD_SWIFT_H
#define MYAPPBROWNFIELD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="myappbrownfield",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15myappbrownfield25ExpoBrownfieldAppDelegate")
...
@class NSCoder;
@class NSBundle;
SWIFT_CLASS("_TtC15myappbrownfield25ReactNativeViewController")
